  ...
  while (TRUE) {
    ...
    for (Index = 1, BootEntry = 1; Index < MaxIndex; Index += 1) {
      ...
      if (SectorCount < 2) {
        ...
        CdDev.PartitionSize = DivU64x32Remainder (
      ...
      PartitionInfo.PartitionNumber = CdDev.BootEntry;
      PartitionInfo.PartitionStart  = CdDev.PartitionStart;
      PartitionInfo.PartitionSize   = CdDev.PartitionSize;
