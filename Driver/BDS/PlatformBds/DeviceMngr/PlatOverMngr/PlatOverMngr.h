...
#define QUESTION_ID(Field)              ((UINTN) &(((MyIfrNVData *) 0)->Field))

#define DRIVER_SELECTION_QUESTION_ID    QUESTION_ID (DriSelection)
#define DRIVER_ORDER_QUESTION_ID    QUESTION_ID (DriOrder)
