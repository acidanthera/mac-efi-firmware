...
#include <Library/AppleInterruptLib.h>
  ...
  )
{
  ...
  Status = AppleInterrupt (APPLE_INTERRUPT_ASSERT, FileName, LineNumber, Description, NULL, NULL);
...
{
  return (BOOLEAN) ((ErrorLevel & GetDebugPrintErrorLevel ()) != 0);
}
